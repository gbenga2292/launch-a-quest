...
import { Search, Eye, RotateCcw, FileText, Trash2, Edit, User, Truck, MapPin } from "lucide-react";
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="col-span-2 flex items-center gap-2 text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1 overflow-hidden">
                      <span className="truncate max-w-[100px]">{getSiteName(waybill.siteId)}</span>
                      <span>→</span>
                      <span className="truncate max-w-[100px]">{getTo()}</span>
                    </div>
                  </div>
                </div>
