...
import { Asset, Site, CompanySettings } from "@/types/asset";
...
interface ConsumableAnalyticsViewProps {
    consumable: Asset;
    site: Site;
...
export const ConsumableAnalyticsView = ({
    consumable,
    site,
    logs,
    companySettings
}: ConsumableAnalyticsViewProps) => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold tracking-tight">Analytics: {consumable.name}</h2>
